...
order.onclick = function () {
  var check =document.getElementById("thoigiannhan").value ;
  if (check!=""){
...
// check nhập trong giỏ hàng
$(function() {
  $("form[name='validateInput']").validate({
    rules: {
      thoigiannhan: "required"
    },
    messages: {
      thoigiannhan: "Hãy nhập thời gian nhận"
    },
